export default {
  ...
  assetLibrary: {
    ...
    profile:
      "witChainD offers efficient document management and intelligent analysis,supporting a variety of file formats including md,xlsx,pdf,doc,docx,pptx,xml and txt.Equipped with an advanced document processing technology and powerful retrieval capabilities of the openEulerCopilot System RAG,WitchainD aims to provide you with an exceptional intelligent Q&A service.",
    message: {
  ...
  dialogTipText: {
    ...
    fileAllFormat:
      "The file can be in .md,.xlsx,.pdf,.doc,.docx,.pptx,.xml or .txt format. A maximum of 100 files with a total size of 500 MB can be uploaded.",
